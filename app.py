...
<div class="main-header">
    ...
    <p>Tác giả: Đỗ Văn Tịnh - Trường Tiểu học Hợp Thành - ĐT: 0985 130 921</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đỗ Văn Tịnh - Trường Tiểu học Hợp Thành - ĐT: 0985 130 921</div>", unsafe_allow_html=True)
